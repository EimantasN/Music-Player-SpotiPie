    ...
    public class PlaylistSongList : FragmentBase
    {
        ...
        public override void ForceUpdate()
        {
            if (RvData == null)
            {
                ...
                RvData.Setup(RecycleView.Enums.LayoutManagers.Linear_vertical, () => { LoadFragmentInner(Enums.Activitys.Player.SongDetails, screen: Enums.LayoutScreenState.FullScreen); });
