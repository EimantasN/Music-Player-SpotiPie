...
namespace SpotyPie.Services
{
    ...
    MediaPlayer.IOnSeekCompleteListener
    {
        ...
        public object Cover
        {
            ...
            {
                if (cover == null)
                    cover = BitmapFactory.DecodeResource(Resources, Resource.Drawable.img_loading);
                return cover;
            }
            private set
            {
        ...
        private void UpdateMediaMetadataCompat(MediaMetadataRetriever metaRetriever = null)
        {
            ...
            {
                builder
                .PutString(MediaMetadata.MetadataKeyAlbum, "The XX")
                .PutString(MediaMetadata.MetadataKeyArtist, "The xx")
                .PutString(MediaMetadata.MetadataKeyTitle, "Intro");
            }
            else
            {
                builder
